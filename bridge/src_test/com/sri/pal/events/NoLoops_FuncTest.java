...
// $Id: NoLoops_FuncTest.java 7401 2016-03-25 20:18:20Z Chris Jones (E24486) $
...
/**
 * Verify that we can disable loop learning.
 */
public class NoLoops_FuncTest
    ...
    public void learnLoopAndSerialize()
            throws Exception {
        ProcedureDef proc = LoopLearning_FuncTest.loopTest1(null);
