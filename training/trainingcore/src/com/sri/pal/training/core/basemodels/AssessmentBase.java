 ...
 *         &lt;element name="task_assessment" type="{}TaskAssessment" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AssessmentBase {
    ...
    @XmlElement(name = "task_assessment", required = true)
    protected List<TaskAssessment> taskAssessment;
    ...
    /**
     * Gets the value of the taskAssessment property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the taskAssessment property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTaskAssessment().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TaskAssessment> getTaskAssessment() {
        if (taskAssessment == null) {
            taskAssessment = new ArrayList<TaskAssessment>();
        }
