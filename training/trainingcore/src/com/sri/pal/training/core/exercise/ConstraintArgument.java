...
public class ConstraintArgument extends ConstraintArgumentBase {
     public boolean isEquivalentTo(ConstraintArgument other) {
         if (getValue() != null && getValue().equals(other.getValue()) ||
             getRef() != null && getRef().equals(other.getRef()))
             return true;
