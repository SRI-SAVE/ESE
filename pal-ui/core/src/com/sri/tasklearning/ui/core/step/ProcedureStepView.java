...
/**
 * View for {@link ProcedureStepModel}. Provides a special tooltip. 
 */
public class ProcedureStepView extends ActionStepView {
    
    public ProcedureStepView(
            final ProcedureStepModel argModel, 
        ...
        appIcon.setToolTipCallback(new IToolTipCallback() {
            public String getToolTipText() {
                return "This action is a user-defined exercise.";
            }
        });
    }   
}
