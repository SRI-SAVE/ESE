...
/**
 * Defines the methods of a variable observer. Variable observers are notified
 * when a variable is added, removed or renamed within the current procedure. 
 */
public interface IVariableWatcher {
